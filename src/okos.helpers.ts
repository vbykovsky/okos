...
export const generateAction = <StateType>(
  action: OkosActionType<StateType>,
  store: { state: StateType; dispatch: (state: StateType) => void }
): __OkosResultActionType => ((payload: OkosActionPayloadType) => {
...
export const generateAsyncAction = <StateType, ActionsType extends OkosActionsType<StateType>>(
  action: OkosAsyncActionType<StateType, ActionsType>,
  actions: ActionsType,
  store: { state: StateType; dispatch: (state: StateType) => void }
): __OkosResultActionType => (async (payload: OkosActionPayloadType) => {
